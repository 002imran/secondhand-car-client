...
const Footer = () => {
    return (
      <div className='mt-20'>
            <footer className="footer sm:footer-center md:footer p-10 px-20 bg-base-200 text-base-content">
                <div>
                    <span className="footer-title">Our Collection</span>
                    <a className="link link-hover">Toyota</a>
                    <a className="link link-hover">Mitsubisi</a>
            ...
            <footer className="footer sm:footer-center md:footer px-20 py-4 border-t bg-base-200 text-base-content border-base-300">
                <div className="flex items-center grid-flow-col">
                    ...
                    <p className='mt-2'>zCar.Recondition car Provider and Buyer since 2012.</p>
                </div>
