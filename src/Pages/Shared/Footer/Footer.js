...
const Footer = () => {
    return (
      <div>
            <footer className="footer sm:footer-center md:footer p-10 bg-base-200 text-base-content">
                <div>
            ...
            <footer className="footer sm:footer-center md:footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
